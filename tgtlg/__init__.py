...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@imagerleech05bot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "luz@imagerleech05bot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "lz@imagerleech05bot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@imagerleech05bot")
...
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "sthumb@imagerleech05bot")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "cthumb@imagerleech04bot")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@imagerleech05bot")
...
TOGGLE_VID = os.environ.get("TOGGLE_VID", "tvid@imagerleech05bot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "tdoc@imagerleech05bot")
